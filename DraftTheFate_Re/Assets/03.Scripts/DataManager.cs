...
public class DataManager : MonoBehaviour
{
    ...
    public CardData this[string name]
    {
        get
        {
            return gameData.cardList[name];
        }
    }
    ...
    public void LoadData()
    {
        ...
        for(int i = 0;i< gameData.cardDataList.Count; i++)
        {
            gameData.cardDataList[i].cardSprite = Resources.Load("CardImage/" + gameData.cardDataList[i].wordIndex) as Sprite;
        }
    }
